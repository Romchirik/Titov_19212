...
void MainWindow::on_actionOpen_triggered() {
    ...
    QString filepath = QFileDialog::getOpenFileName(
        this, tr("Open Project"), "", tr("Golly generated files (*.rle)"));
...
void MainWindow::on_actionOpen_as_template_triggered() {
    game->stopGame();
    QString filepath = QFileDialog::getOpenFileName(
        this, tr("Open Template"), "", tr("Golly generated files (*.rle)"));
    size_t ok = f_handler.parseFile(filepath);
    if (!ok) {
        ...
        case ACCESS_DENIED: {
            QMessageBox::warning(this, tr("GameLife"), tr("Access denied"),
                                 QMessageBox::Ok);
            break;
        }
        case WRONG_FORMAT: {
            QMessageBox::warning(this, tr("GameLife"), tr("Wrong file format"),
                                 QMessageBox::Ok);
            break;
        }
        }
